...
class ResidenceType {
	...
	public function register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Types', 'Taxonomy General Name', 'VacancesPourSeniors' ),
			'singular_name'              => _x( 'Type', 'Taxonomy Singular Name', 'VacancesPourSeniors' ),
			'menu_name'                  => __( 'Types', 'VacancesPourSeniors' ),
		...
		register_taxonomy( 'residence_type', array( 'residence' ), $args );
	}
}
