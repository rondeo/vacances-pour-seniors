...
class ResidenceStatus {
	...
	public function register_taxonomy() {
		...
		$labels = array(
		'name'                       => _x( 'Status', 'Taxonomy General Name', 'VacancesPourSeniors' ),
		'singular_name'              => _x( 'Status', 'Taxonomy Singular Name', 'VacancesPourSeniors' ),
		'menu_name'                  => __( 'Status', 'VacancesPourSeniors' ),
		...
		register_taxonomy( 'residence_status', array( 'residence' ), $args );
	}
}
