...
class Country {
	...
	public function register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Pays', 'Taxonomy General Name', 'VacancesPourSeniors' ),
			'singular_name'              => _x( 'Pays', 'Taxonomy Singular Name', 'VacancesPourSeniors' ),
			'menu_name'                  => __( 'Pays', 'VacancesPourSeniors' ),
			...
			'add_new_item'               => __( 'Ajouter un nouveau pays', 'VacancesPourSeniors' ),
			'edit_item'                  => __( 'Edit Item', 'VacancesPourSeniors' ),
			'update_item'                => __( 'Mettre à jour le pays', 'VacancesPourSeniors' ),
			...
			'not_found'                  => __( 'Aucun pays n\'a été trouvée', 'VacancesPourSeniors' ),
		...
		register_taxonomy( 'country', array(), $args );
	}
}
