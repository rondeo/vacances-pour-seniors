...
/**
 * Residence social life tag class
 */
class ResidenceSocialLife {
	...
	public function register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Vies sociales', 'Taxonomy General Name', 'VacancesPourSeniors' ),
			'singular_name'              => _x( 'Vie sociale', 'Taxonomy Singular Name', 'VacancesPourSeniors' ),
			'menu_name'                  => __( 'Vies sociales', 'VacancesPourSeniors' ),
			...
			'add_new_item'               => __( 'Ajouter une nouvelle vie sociale', 'VacancesPourSeniors' ),
			...
			'not_found'                  => __( 'Aucune vie sociale n\'a été trouvée', 'VacancesPourSeniors' ),
		...
		register_taxonomy( 'residence_social_life', array( 'residence' ), $args );
	}
}
